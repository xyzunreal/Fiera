...
int main()
{
    ...
    conv_layer_t * layer1 = new conv_layer_t(1, 3, 8, cases[0].data.size,false);		
    batch_norm_layer_t * layerbb = new batch_norm_layer_t(layer1->out.size, false);
    prelu_layer_t * layer2 = new prelu_layer_t( layerbb->out.size,false);
    conv_layer_bin_t * layer3 = new conv_layer_bin_t(1, 3, 16, layer2->out.size,false);		
    batch_norm_layer_t * layerb = new batch_norm_layer_t(layer3->out.size, false);
    prelu_layer_t * layer4 = new prelu_layer_t( layerb->out.size,false);
    fc_layer_bin_t * layer5 = new fc_layer_bin_t(layer4->out.size, 70, false);
    prelu_layer_t * layer6 = new prelu_layer_t( layer5->out.size,false); 
    fc_layer_t * layer7 = new fc_layer_t(layer6->out.size, 10, false);
    softmax_layer_t * layer8 = new softmax_layer_t(layer7->out.size, true,false);
    ...
    for(int epoch = 0; epoch<15; epoch++){
        ...
        for(int batch_num = 0; batch_num<3; batch_num++){
                ...
                float l1 = cross_entropy(layer8->out, cases[batch_num].out,true)(0, 0, 0, 0);
                float l2 = l1;
